...
if($device=='mobile')
{
    ...
    $photo_location="images/mobile/".md5($photo['name']).".".$fileExt;
...
else if($device=='laptop')
{
    ...
    $sql="INSERT INTO mobile (photo,price,brand,model_name,model_number,ram,gpu,os,processor_type,hdd_space,battery) VALUES ( '$photo_location','$price', '$brand', '$model_name', '$model_num', '$ram', '$gpu', '$os', '$processor_type', '$hdd_space', '$battery') ;";
...
else if($device=='camera')
{
    ...
    $sql="INSERT INTO mobile (photo,price,brand,model_name,model_num,megapixel,sensor_type,type) VALUES ( '$photo_location','$price', '$brand', '$model_name', '$model_num', '$megapixel','$sensor_type','$type') ;";
